 ...
 * that they are capable of storing overall runtime information.
 * <p>
 * Implementing classes: {@link RuntimeInformation}
 * <p>
 * Extended interfaces: {@link IRuntimeCandidateSearcher}, {@link IRuntimePositionOptimizer},
 *  					{@link IRuntimeIlluminationTester}, {@link IRuntimeReader}
 * <p>
 * @author alex
 *
 */
