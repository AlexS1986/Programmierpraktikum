...
public class WallContainerNorth extends WallContainerAbstract{
	 ...
	 * @throws WallContainerException
	 */
	public Wall getNearestNorthWall(int xLow, int xHigh, int yLow) throws WallContainerException{
