...
/**
 * A provider of an algorithm that provides persistence to an {@link IRoom} instance.
 * @author alex
 *
 */
public interface IPersistence {
	 ...
	 * @throws PersistenceException : thrown if an unexpected error occurred during the reading process.
	 */
	 ...
	 * @param location : The location at which the {@link IRoom} is stored.
	 * @throws PersistenceException : thrown if an unexpected error occurred during the writing process.
	 */
