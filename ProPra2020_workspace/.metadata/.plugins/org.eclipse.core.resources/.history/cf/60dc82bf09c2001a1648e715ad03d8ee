...
public class Wall extends LineSegment{
	...
	/**
	 * Constructor
	 * @param lineSegment : The {@link LineSegment} that
	 * the new {@link Wall} should be identical with 
	 * in a geometrical sense
	 * @param tag : The tag of the new {@link Wall}
	 */
	public Wall(LineSegment lineSegment, int tag) {
		super(lineSegment.getP1(), 
				lineSegment.getP2());
		this.tag = tag;
	}
	 ...
	 * {@link Wall} is a north {@link Wall}, i.e. the 
	 * interior of a potential associated {@link IRoom}
	 * is to its south.
	 */
	 ...
	 * 
	 * @return A boolean that represents whether this
	 * {@link Wall} is a west {@link Wall}, i.e. the 
	 * interior of a potential associated {@link IRoom}
	 * is to its east.
	 */
	 ...
	 * 
	 * @return A boolean that represents whether this
	 * {@link Wall} is a south {@link Wall}, i.e. the 
	 * interior of a potential associated {@link IRoom}
	 * is to its north.
	 */
	 ...
	 * 
	 * @return A boolean that represents whether this
	 * {@link Wall} is an east {@link Wall}, i.e. the 
	 * interior of a potential associated {@link IRoom}
	 * is to its west.
	 */
