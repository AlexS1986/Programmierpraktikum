...
/**
 * Provides an algorithm to computes all orginal partial rectangles of an {@link IRoom} instance and to tag
 * these rectangles with tags that correspond to a portion of the {@link IRoom} that is illuminated if the associated
...
public class OriginalPartialRectanglesFinder implements IOriginalPartialRectanglesFinder{
	...
	private static double findWallTOL = 0.001; // necessary in order to correctly determine original partial rectangles TODO set it to size of room?
	...
	private HashSet<Rectangle> originalRectangles = new HashSet<Rectangle>(); // all original partial rectangles of the room
	private ArrayList<RectangleWithTag> originalRectanglesTagged = new ArrayList<RectangleWithTag>(); // all tagged tagged original partial rectangles
	...
	/**
	 * Sorts all walls of the {@link IRoom} instance to suited containers depending on their orientation
	 * <p>
	 * Package access is granted for testing purposes.
	 * <p>
	 * @param room : The {@link IRoom} for which the {@link Wall}s need to be sorted 
	 * @throws OriginalPartialRectanglesFinderException : thrown if wall orientation of a wall of the {@link IRoom} cannot be 
	 * 		   determined
	 */
	...
	/**
	 * Constructs the original partial rectangles for an {@link IRoom} and tags the rectangles with 
	 * the {@link Wall} indices that correspond to {@link Wall}s that are illuminated if the rectangle
	 * is illuminated.
	 * <p>
	...
	/**
	 * Finds tags for original rectangles and adds it to global original rectangles if this rectangle does
	 * not already exist
	 * @param yNorth
	 * @param xWest
	 * @param xEast
	 ...
	 * @return a set of tags that corresponds to the tags of the {@link Wall}s illuminated by that rectangle
	 */
