 ...
 * the part of the algorithm that deals with finding the original partial
 * rectangles of the {@link IRoom}.
 * <p>
...
public interface IRuntimeOriginalPartialRectanglesFinder {
	/**
	 * Start the clock for the part of the algorithm that deals with finding the
	 * original partial rectangles of the {@link IRoom}..
	 * 
	...
	/**
	 * Stop the clock for the part of the algorithm that deals with finding the
	 * original partial rectangles of the {@link IRoom}.
	 * 
	 * @throws RuntimeExceptionLamps : if not handled correctly
	 */
