...
/**
 * A rectangle that can also be tagged, i.e. have a set of integers that
 * represent the tags.
 * <p>
 * The {@link RectangleWithTag} is designed to represent an original partial
 * rectangle of an {@link IRoom} instance. The tags typically represent the
 * portions of the {@link IRoom} that are illuminated if the associated
 * {@link RectangleWithTag} is illuminated. This means that the union of the
 * tags of all {@RectangleWithTag}s of an {@link IRoom} should be equal to all
 * tags, i.e. all portions of the {@link IRoom}. The tags are stored internally
 * as a {@link HashSet}<{@link Integer}>.
 * <p>
 * <p>
...
public class RectangleWithTag extends Rectangle {
	 ...
	 * Constructor
	 * 
	 * @param rectangle   : A {@link Rectangle} that is used to create the new
	 *                    {@link RectangleWithTag}
	 * @param initialTags : a {@link Collection} of initial tags.
	 */
	 ...
	 * @return : a boolean that represents whether this {@link RectangleWithTag}
	 *         contains the tag
	 */
	 ...
	 * 
	 * @return : A {@link HashSet} with all copies of the tags of this
	 *         {@link RectangleWithTag}.
	 */
	...
	public boolean equals(Object o) {
		...
		return getP1().equals(r.getP1()) && getP2().equals(r.getP2()) && getP3().equals(r.getP3())
				&& getP4().equals(r.getP4()) && getSumOfTags() == r.getSumOfTags();
	}
