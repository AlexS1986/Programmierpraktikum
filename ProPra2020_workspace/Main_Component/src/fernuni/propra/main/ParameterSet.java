...
/**
 * Supports parsing parameter Strings that are provided via the command line
 * when calling ProPra.jar.
 * <p>
 * 
 * @author alex
 *
...
public class ParameterSet {
	...
	/**
	 * Checks whether the provided String parameter is a valid value of "r". If it
	 * is valid it will be accepted as the value of r.
	 * 
	 * @param runParameter: the requested value of "r".
	 * @throws ParameterSetException : if runParameter is not valid or "r" has
	...
	/**
	 * Checks whether a value for "if" has not already been specified. If not the
	 * value for "if" is accepted.
	 * 
	 * @param inputFile : the desired value for "if"
	 * @throws ParameterSetException : thrown if "if" has already been specified.
	 */
	...
	/**
	 * Checks whether a value for "l" has not already been specified. If not the
	 * value for "l" is accepted.
	 * 
	 * @param timeLimit : the desired value for "l" in seconds
	 * @throws ParameterSetException : thrown if "l" has already been specified.
	 */
	...
	/**
	 * Checks whether the values given for "r" (mandatory), "if" (mandatory) and "s"
	 * (mandatory for r=s or r=sd) add up to a valid input specification.
	 * 
	 * @return A boolean that represents whether the parameter set is valid (true)
	 *         or not (exception is thrown to return specific advice to the caller).
	 * @throws ParameterSetException : thrown if parameter set is not valid
	 *                               getMessage() should be called to get specific
	 *                               advice on how to fix the error.
	 */
