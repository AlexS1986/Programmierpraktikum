...
public class LineSegmentTest {
	...
	public void testLineSegmentDoesNotIntersectLineSegments() {
		...
		// Act
		boolean test1 = ls1.doesNotIntersectLineSegments(lineSegments);
		boolean test2 = ls2.doesNotIntersectLineSegments(lineSegments);
		boolean test3 = ls3.doesNotIntersectLineSegments(lineSegments);
		boolean test4 = ls4.doesNotIntersectLineSegments(lineSegments);
		boolean test5 = ls5.doesNotIntersectLineSegments(lineSegments);
		boolean test6 = ls6.doesNotIntersectLineSegments(lineSegments);
		boolean test7 = ls7.doesNotIntersectLineSegments(lineSegments);
		boolean test8 = ls8.doesNotIntersectLineSegments(lineSegments);
