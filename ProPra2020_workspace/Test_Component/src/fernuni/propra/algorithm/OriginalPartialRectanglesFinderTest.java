...
public class OriginalPartialRectanglesFinderTest {
	...
	public void testGetAllTags() {
		...
		//Assert
		assertTrue("Did not return the correct tags.",
				rectanglesFinder.getAllTags().containsAll(refSet));
	}
	...
	public void testSortWallsToContainers() {
		//Arrange
				OriginalPartialRectanglesFinder originalRectanglesFinder 
				= new OriginalPartialRectanglesFinder();
				//Act
				try {
				...
				boolean test13 = wallEast.getP1().equals(w2.getP1()) 
						&& wallEast.getP2().equals(w2.getP2());
				...
				boolean test23 = wallNorth.getP1().equals(w3.getP1()) 
						&& wallNorth.getP2().equals(w3.getP2());
				...
				boolean test33 = wallWest.getP1().equals(w4.getP1()) 
						&& wallWest.getP2().equals(w4.getP2());
				...
				boolean test43 = wallSouth.getP1().equals(w1.getP1()) 
						&& wallSouth.getP2().equals(w1.getP2());
	...
	public void testConstructOriginalPartialRectangles() {
				// Arrange
				OriginalPartialRectanglesFinder rectanglesFinderRoomSquare =
						new OriginalPartialRectanglesFinder();
				OriginalPartialRectanglesFinder rectanglesFinderRoomL =
						new OriginalPartialRectanglesFinder();
				...
				//Assert
				// 1st room
				Iterator<RectangleWithTag> roomSquareIterator = 
						rectanglesFinderRoomSquare.iteratorOriginalRectangles();
				...
				assertTrue("More than one rectangle has been returned for"
						+ "square room!",only1Rectangle);
				assertTrue("The correct rectangle has been returned",
						correctRectangle);
				
				// 2nd room
				Iterator<RectangleWithTag> roomLIteator = 
						rectanglesFinderRoomL.iteratorOriginalRectangles();
				...
				boolean correctRectangle1 = rec2_1.equals(ref2) ||
						rec2_1.equals(ref3);
				boolean correctRectangle2 = rec2_2.equals(ref3) ||
						rec2_2.equals(ref2);
				
				assertTrue("2 rectangles need to be returned",
						only2Rectangles);
	...
	public void testConstructOriginalPartialRectanglesComplicated() {
		...
		ArrayList<RectangleWithTag> originalPartialRectangles =
