...
public class WallContainerSouthTest {
	...
	/**
	 * tests whether south wall can be added and whether an east wall throws an
	 * exception.
	 */
	@Test
	public void testAdd() {
		...
		// Assert
		assertTrue("Adding an east wall should  throw an exception", eastWallAddedWException);
		assertTrue("Adding a south wall should throw an exception", southWallAddedWOException);
	}

	/**
	 * Tests whether the nearest south wall is indeed returned.
	 */
	@Test
	public void testGetNearestSouthWall() {
		...
		boolean isLowerWall = w10.getP1().equals(w1.getP1()) && w10.getP2().equals(w1.getP2());
		...
		boolean isUpperWall = w11.getP1().equals(w7.getP1()) && w11.getP2().equals(w7.getP2());
		...
		boolean isUpperWall2 = w12.getP1().equals(w7.getP1()) && w12.getP2().equals(w7.getP2());
