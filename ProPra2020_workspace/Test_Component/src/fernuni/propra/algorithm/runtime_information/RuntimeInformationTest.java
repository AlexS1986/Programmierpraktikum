...
public class RuntimeInformationTest {
	...
	public void testStartStopGetTimeCandidateSearch() {
		...
		assertTrue("Incorrect program flow not detected", incorrectProgramFlowDetected);

		// incorrect program flow
		assertTrue("Incorrect program flow not detected", incorrectProgramFlowDetected2);
	}
	...
	public void testToString() {
		...
		// Assert
		assertTrue("A String needs to be returned", outString != null);
	}
