...
public class RectangleTest {
	...
	public void testOverlap() {
		...
		Rectangle rec2 = new Rectangle(p5, p7); // overlap north east
		Rectangle rec3 = new Rectangle(p5, p3); // overlap north east
		Rectangle rec5 = new Rectangle(p3, p7); // no overlap
		Rectangle rec8 = new Rectangle(p10, p9); // no overlap
		Rectangle rec9 = new Rectangle(p1, new Point(0.5, 1.0)); // overlap left
		Rectangle rec11 = new Rectangle(p2, new Point(2 * p2.getX(), 1.0)); // no overlap
		...
		assertTrue("No overlap should have been detected", rec6 == null);
		assertTrue("Overlap not correct", rec7.equals(rec));
		assertTrue("Overlap not correct", rec9.equals(rec10));
		assertTrue("Overlap should not have been detected", rec12 == null);

	}

	/**
	 * checks whether rectangle can return its center
	 */
	@Test
