...
public class LineSegmentTest {
	...
	public void testGetP1() {
		...
		// Assert
		assertSame("P1 not returned correctly", p1, px);
	...
	public void testGetP2() {
		...
		// Assert
		assertSame("P1 not returned correctly", p2, px);
	}
	...
	public void testIsHorizontal() {
		...
		LineSegment horizontalLine = new LineSegment(p1, new Point(1, 0));
		...
		try {
			...
			fail("An Exception should have been thrown for" + "invalid LineSegment");
		} catch (NullPointerException ex) {
		}

		// Assert
		assertTrue("This line is not horizontal!", !isHorizontal);
		assertTrue("This line is horizontal", isHorizontal2);
	...
	public void testIsVertical() {
		...
		// Assert
		assertTrue("This line should be vertical.", isVertical);
		assertFalse("This line should not be vertical!", isVertical2);
	}
