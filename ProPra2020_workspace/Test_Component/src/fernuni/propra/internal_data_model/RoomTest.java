...
public class RoomTest {
	...
	public void setUp() {
		...
		cornersClockWise.add(p1);
		cornersClockWise.add(p4);
		cornersClockWise.add(p3);
		cornersClockWise.add(p2);
	...
	public void testGetWalls() {
		...
		assertTrue("Counter clockwise room does not work", test1 && test2 && test3 && test4);
		assertTrue("Clock Wise Room does not work", test5 && test6 && test7 && test8);
	}
	...
	public void testGetCorners() {
		...
		Room roomClockWise = new Room("test", null, cornersClockWise);
		// Act
		Iterator<Point> cornerIterator = roomClockWise.getCorners();
		...
		// Assert
		assertTrue("The corners have not been returned in" + "counter clockwise order",
	...
	public void testGetNumberOfLamps() {
		...
		// Assert
		assertTrue("21 lamps should have been returned", numberLamps == 21);
